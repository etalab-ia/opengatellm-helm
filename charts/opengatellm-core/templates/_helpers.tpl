...
{{/*
Fully qualified name of the CNPG postgresql Cluster. Mirrors the logic of
the cnpg/cluster subchart's "cluster.fullname" helper, applied to the
.Values.postgresql scope, so the secret <name>-app generated by CNPG and
the one looked up by this chart always match.
*/}}
{{- define "opengatellm-core.postgresql.fullname" -}}
{{- if .Values.postgresql.fullnameOverride -}}
{{- .Values.postgresql.fullnameOverride | trunc 63 | trimSuffix "-" -}}
{{- else -}}
{{- $name := default "cluster" .Values.postgresql.nameOverride -}}
{{- if contains $name .Release.Name -}}
{{- .Release.Name | trunc 63 | trimSuffix "-" -}}
{{- else -}}
{{- printf "%s-%s" .Release.Name $name | trunc 63 | trimSuffix "-" -}}
